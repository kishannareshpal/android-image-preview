...
//        private var mList: ArrayList<Uri> = arrayListOf()
        ...
        private fun initButton() {
            ...
            if (mPreviewConfig.isDoneButtonVisible) {
                preview_fragment_iv_done.visibility = View.VISIBLE
            } else {
                preview_fragment_iv_done.visibility = View.GONE
            }
